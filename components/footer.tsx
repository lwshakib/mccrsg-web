    ...
    <footer className="border-t border-border bg-background text-foreground">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="ml-3 text-xl font-bold">
                MC Rover Scout Troup
              </span>
            </div>
            <p className="text-sm text-muted-foreground">
              Inspiring leadership, service, and adventure for the next
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center text-muted-foreground">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} MC Rover Scout Troup. All rights
            reserved.
          </p>
